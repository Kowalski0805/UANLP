...
class TextDataFrame(IText):
    ...
    def split_to_sentences(self):
        ...
        self.text = sents.withColumn("body_vec", split_words("body_vec")).withColumn("title_vec",
                                                                                     split_words("title_vec"))
    ...
    def tokenize(self):
        ...
        self.text = self.text.withColumn("body_vec", norm_sent("body_vec")).withColumn("title_vec",
                                                                                       norm_sent("title_vec"))
    ...
    def filter_stop_words(self, stop_words=None):
        ...
        self.text = self.text.withColumn("body_vec", filter_words("body_vec")).withColumn("title_vec",
                                                                                          filter_words("title_vec"))
    ...
    def process_once(self):
        self.text = (self.text
                     .withColumn("body_vec", udf(lambda e: process_udf(e))("body"))
                     .withColumn("title_vec", udf(lambda e: process_udf(e))("title")))
        return self
